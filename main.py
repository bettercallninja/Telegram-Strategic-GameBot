...
def show_assets(message):
    ...
    if user:
        assets_message = (
            ...
            f"🛳️ کشتی بزرگ: {user[17]}</blockquote>\n\n"
            f"🏭 کارخانجات:\n"
            f"<blockquote>کارخونه سنگ: {user[18]}\n"
            ...
            f"بانک🏦: {user[25]}</blockquote>\n\n"
            f"⚔️کمپ‌ها:\n"
            f"<blockquote>کمپ سرباز شمشیرزن: {user[26]}\n"
            f"کمپ سرباز تفنگدار: {user[27]}\n"
            f"کمپ سواره‌نظام شمشیرزن: {user[28]}\n"
            f"کمپ سواره‌نظام تفنگدار: {user[29]}\n"
            f"کمپ گارد ویژه: {user[30]}</blockquote>\n\n"
            f"🔧 کارخانجات توپخانه:\n"
            f"<blockquote>کارخانه توپ متوسط: {user[31]}\n"
            f"کارخانه توپ بزرگ: {user[32]}</blockquote>\n\n"
            f"⚓کشتی‌سازی‌ها:\n"
